...
global dataset;
dataset = Dataset('parking'); % options: 'kitti', 'malaga', 'parking', 'bike_straight', 'fpv1', 'fpv2', 'fpv3'
...
while(~found_next_keyframe)
    ...
    [matched_logic_keyframe, all_KLT_keypoints, all_candidates] = matching(...
        prev_frame,candidate_frame,tracked_keypoints_from_first_frame,dataset.options.matching{:});
    ...
    [R_C_W, t_C_W] = decompose_fundamental_matrix(...
        F,dataset.K,matched_keypoints_first_frame(:,inliers),tracked_keypoints_from_first_frame(:,inliers));
